...
public final class Update implements TelegramObject {

	private final int id;
	private final Message message;

	public Update(JSONObject object) {
		id = object.getInt("update_id");
		message = object.has("message") ? new Message(object.getJSONObject("message")) : null;
	}
